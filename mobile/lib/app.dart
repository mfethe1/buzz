...
class App extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(
      ...
      // viewport rather than to the message row. The age-signal gate wraps the
      // shell: a restriction cannot be bypassed by a route pushed while the
      // store signal request was in flight.
